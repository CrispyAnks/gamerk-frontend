...
return (
  <>
    <Button variant="warning" onClick={handleShow} style={{margin:'0 0 0 1rem'}}>
      {props.bottonName}
    </Button>
    ...
    <Modal show={show} onHide={handleClose}>
      ...
      <Modal.Body>
              ...
              <table class="table table-borderless">
                    ...
                    <tr>
                      <th>ニックネーム:</th>
                      <td><input type="text" placeholder="New Nickname" name="rating" onChange={ratingHandler}/></td>
                    </tr>
                    
                    <tr>
                      <th>性別:</th>
                      <td><input type="text" placeholder="" name="rating" onChange={statusHandler}/></td>
                    </tr>
                    <tr>
                    {/* <th>アバター:</th>
                    <td>
